...
//				  		----
					...
					?>
						<a href="#"><h1>Bảng điểm cuối kì HK1 (mã lớp: <?php echo $_GET['idMaLop'].")"?></h1></a><br>
						<a href="#"><h1>Mã môn: <?php echo $_GET['idMaMon']?></h1></a><br>
					<form action="UpdatePointCK_HK1.php" method="POST">
						<table>
							<tr>
								<td>STT</td>
								<td >MaHS</td>
								<td >Tên HS</td>
								<td >Điểm cuối kì (hk1)</td>			
							</tr>
							<?php
								$stt=0;
								...
								<td><input class="focusPoint" type="number" name="pointCK_HK1<?php echo $stt; ?>" step="0.25" min="0" max="10" ></td>	
							</tr>
							<?php 
								}?>
						 </table>
