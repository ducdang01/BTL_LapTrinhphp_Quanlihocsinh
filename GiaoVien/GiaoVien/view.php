						...
						<div class="content_tieude">
							...
							<div>
								...
								<p>Điện thoại: 
									<?php
									$thongTin = new Exe();
									echo $thongTin->get_item('giaovien','DienThoai',$_SESSION['user'],$_SESSION['pass'],'MaGV');      
									?>
								</p>
								...
								<p>Địa chỉ: 
									<?php
									$thongTin = new Exe();
									echo $thongTin->get_item('giaovien','DiaChi',$_SESSION['user'],$_SESSION['pass'],'MaGV');      
									?>
								</p>
								...
								<p>Ghi chú: 
									<?php
									$thongTin = new Exe();
									echo $thongTin->get_item('giaovien','GhiChu',$_SESSION['user'],$_SESSION['pass'],'MaGV');      
									?>
								</p>

								<p>Cấp bậc: Giáo viên </p>
								
								<p><a href="./editInformation.php">Sửa thông tin cá nhân</a></p>
