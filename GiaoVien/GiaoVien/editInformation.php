                ...
                <div class="class content_home">
					...
					<div class="class content_home">
						<div class="content_tieude">
							...
							<a href="#">
							<?php
												if(isset($_SESSION['loiInf']) && $_SESSION['loiInf']==1)
												{
													echo "<br><b><i>Cập nhật thất bại(Thông tin không được bỏ trống)</i></b>";
													$_SESSION['loiInf']=0;
												}
												if(isset($_SESSION['loiInf']) && $_SESSION['loiInf']==2)
												{
													echo "<br><b><i>Cập nhật thành công</i></b>";
													$_SESSION['loiInf']=0;
												}
												if(isset($_SESSION['loiInf']) && $_SESSION['loiInf']==3)
												{
													echo "<br><b><i>Cập nhật thất bại (số điện thoại không hợp lệ)</i></b>";
													$_SESSION['loiInf']=0;
												}
							?>
							</a>
							<div>
								<form action="./update_infor_teacher.php" method="POST">
                                    ...
                                    <?php
										$thongTin = new Exe();
										echo $thongTin->get_item('giaovien','TenGV',$_SESSION['user'],$_SESSION['pass'],'MaGV');      
										?>
									</p>

									<p>Điện thoại: 
										<input type="text" name="DienThoai" class="box"></imput>
									</p>

									<p>Địa chỉ: 
										<input type="text" name="DiaChi" class="box"></imput>
									</p>

									<p>Ghi chú: 
										<input type="text" name="GhiChu" class="box"></imput>
									</p>
