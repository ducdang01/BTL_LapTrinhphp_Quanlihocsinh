	       ...
	       <div class="content">
              <div class="content_home">
				  <?php
					...
					?>
						<a href="#"><h1>Bảng điểm 1 tiết HK2 (mã lớp: <?php echo $_GET['idMaLop'].")"?></h1></a><br>
						<a href="#"><h1>Mã môn: <?php echo $_GET['idMaMon']?></h1></a><br>
					<form action="UpdatePoint45HK2.php" method="POST">
							<table>
								<tr>
									<td>STT</td>
									<td >MaHS</td>
									<td >Tên HS</td>
									<td >Điểm 45 phút (hk2)</td>			
								</tr>
								<?php
									$stt=0;
									...
									<td><input class="focusPoint" type="number" name="point45_HK2<?php echo $stt; ?>" step="0.25" min="0" max="10" ></td>			</tr>
								<?php 
									}?>
							</table>
