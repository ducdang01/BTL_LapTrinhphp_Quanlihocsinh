...
//				  		----
					...
					?>
							...
							<a href="#"><h1>Bảng điểm 15 phút học kì 1 (mã lớp: <?php echo $_GET['idMaLop'].")"?></h1></a><br>
							<a href="#"><h1>Mã môn: <?php echo $_GET['idMaMon']?></h1></a><br>
					<form action="UpdatePoint15HK1.php" method="POST">
								<table>
									<tr>
										<td>STT</td>
										<td >MaHS</td>
									...
									<?php
										...
										<td><input type="number" name="point15_HK1<?php echo $stt; ?>" step="0.25" min="0" max="10" class="focusPoint"></td>		
									</tr>
									<?php 
