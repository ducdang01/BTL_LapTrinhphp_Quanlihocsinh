	       ...
	       <div class="content">
              <div class="content_home">
				  <?php
					...
					?>
						<a href="#"><h1>Bảng điểm 1 tiết HK1 (mã lớp: <?php echo $_GET['idMaLop'].")"?></h1></a><br>
						<a href="#"><h1>Mã môn: <?php echo $_GET['idMaMon']?></h1></a><br>
					<form action="UpdatePoint45HK1.php" method="POST">
							<table>
								<tr>
									<td>STT</td>
									<td >MaHS</td>
									<td >Tên HS</td>
									<td >Điểm 45 phút (hk1)</td>			
								</tr>
								...
								<?php
									...
									<td><input class="focusPoint" type="number" name="point45_HK1<?php echo $stt; ?>" step="0.25" min="0" max="10" ></td>			
								</tr>
								<?php 
									}?>
							</table>
